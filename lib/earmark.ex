defmodule Earmark do
  ...
  * Rendering of block and inline elements.
  ...
  if (Elixir.Version.compare(vsn = Elixir.System.version, "1.4.0")) == :lt, do:
    IO.puts( :stderr, "Usage of Elixir versions < 1.4.0 is deprecated, please upgrade from your version #{vsn}" )
